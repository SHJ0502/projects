...
public class Scope1Controller extends HttpServlet {
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String dir = config.getInitParameter("saveDirectory");
		String size = config.getInitParameter("maxUploadSize");
		String role = config.getInitParameter("role");			// 값을  조회하지 못함
